...
if($categoryCodeOld==$categoryCode){
    ...
    if($categoryName==$categoryNameOld){
        ...
        if(mysql_num_rows($checkCategories1)<=0){
...
mysql_free_result($checkCategories1);
mysql_free_result($checkCategories2);
mysql_free_result($checkCategories3);